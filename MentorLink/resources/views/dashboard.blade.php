...
@if($user->role === 'mentee')
    <!-- Layout spécial pour les mentees -->
    <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <a href="{{ route('sessions.index') }}" class="btn btn-outline-success w-100">
    ...
    <!-- Statistiques en bas pour les mentees -->
    @if(count($stats) > 0)
    <div class="row">
        <div class="col-md-12">
            <div class="card stat-card">
                <div class="card-body text-center">
                    ...
                    <h2 class="mb-2">{{ $stats['available_mentors'] }}</h2>
                    <h5 class="text-muted">Mentors disponibles</h5>
                    <p class="text-muted mb-0">Prêts à vous accompagner dans votre apprentissage</p>
                </div>
            </div>
        </div>
    </div>
